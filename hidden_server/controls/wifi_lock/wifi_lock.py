...
from hidden_server.settings import WiFiLockSettings
...
class WiFiLock():
	...
	def __init__(self, serial_num):
		self.__device = Device('wifi_lock', serial_num)
		self.__control = Controller('wifi_lock', serial_num)
		self.__settings = WiFiLockSettings()
