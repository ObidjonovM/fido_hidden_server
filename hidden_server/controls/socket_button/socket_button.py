...
from hidden_server.settings import SocketButtonSettings
...
class SocketButton():
	...
	def __init__(self, serial_num):
		self.__device = Device('socket_button', serial_num)
		self.__control = Controller('socket_button', serial_num)
		self.__settings = SocketButtonSettings()
